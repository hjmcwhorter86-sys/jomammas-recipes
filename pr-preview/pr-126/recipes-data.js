...

{
  ...
  category: ["Slow Cooker", "Chicken", "Low Calorie"],
...

{
  ...
  category: ["Soup", "Beef", "Low Calorie"],
...

{
  ...
  description: "Savory ground beef stroganoff with browned mushrooms, a tangy Worcestershire Dijon kick, and a rich sour cream finish over egg noodles.",
  ...
  protein: "",
  servings: "6",
  tags: ["ground beef", "mushrooms", "pasta", "weeknight dinner", "comfort food"],

  ingredients: [
    { qty: 12, unit: "oz", name: "egg noodles" },
    { qty: 1.5, unit: "lb", name: "ground beef (93/7)", notes: "lean" },
  ...
  steps: [
    ...
    "Brown the mushrooms: Heat the olive oil in a large skillet over medium-high heat. Add the mushrooms in a single layer and let sit undisturbed for 3 to 4 minutes until deeply browned before stirring. Cook until golden all over, about 8 minutes total. Remove mushrooms to a plate and set aside.",
    "Brown the beef: In the same skillet, add the ground beef. Press it into an even layer and let it sit undisturbed for 3 to 4 minutes to build a brown crust on the bottom of the pan before breaking it up. Continue cooking until fully browned, around 8 minutes.",
    ...
    "Bring it together: Return the reserved mushrooms to the pan and stir in the butter. Reduce heat to low and stir in the sour cream until fully incorporated. Do not let it boil once the sour cream is in, or it may break.",
